...
}).controller('UserFormCtrl', function(${symbol_dollar}scope, ${symbol_dollar}modalInstance, Users, Roles, user) {
	${symbol_dollar}scope.roles = [];
	${symbol_dollar}scope.user = user;

	${symbol_dollar}scope.isNew = !angular.isDefined(${symbol_dollar}scope.user);
...
}).controller('UserChangePasswdFormCtrl', function(${symbol_dollar}scope, ${symbol_dollar}modalInstance, user) {
	user.password = '';
	${symbol_dollar}scope.user = user;

	${symbol_dollar}scope.submit = function(u) {
		${symbol_dollar}scope.error = false;
